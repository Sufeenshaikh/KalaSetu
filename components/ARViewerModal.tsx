...
// FIX: Added type definitions for the custom <model-viewer> web component. This resolves the error
// "Property 'model-viewer' does not exist on type 'JSX.IntrinsicElements'" by augmenting the
// global JSX.IntrinsicElements interface.
declare global {
  namespace JSX {
